...
met_filtered %>%
  ...
  ggplot(aes(x = mean_temp, y = mean_wind)) +
  ...
  labs(
    x = "Hourly mean temperature",
    y = "Hourly mean wind speed",
    title = "Correlation between hourly mean temperature and wind speed"
  ) +
...
The correlation seems *very* strong. Let's manually examine the data to make sure that makes sense. 
...
After looking at the mean temperature and mean wind globally by hour, the trend does seem to check out!